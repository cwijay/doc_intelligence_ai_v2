        ...
        try:
            ...
            async with db.session() as session:
                ...
                result = await session.execute(
                    text("""
                        SELECT
                            ...
                            st.max_file_size_mb,
                            st.max_concurrent_jobs,
                            st.requests_per_minute,
                            st.requests_per_day,
                            st.features,
                            ...
                            st.monthly_llamaparse_pages as monthly_llamaparse_pages_limit,
                            st.monthly_file_search_queries as monthly_file_search_queries_limit,
                            (st.storage_gb_limit * 1024 * 1024 * 1024)::bigint as storage_limit_bytes,
                ...
                return {
                    ...
                    "tier": row.tier_name,  # Alias for compatibility
