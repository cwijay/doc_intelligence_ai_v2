...
# Optional - Document Parser
DOCUMENT_PARSER=gemini          # gemini (default, fast) | llamaparse (full-featured)
# Gemini parser settings
GEMINI_PARSE_MODEL=gemini-3-flash-preview
GEMINI_PARSE_MODEL_HIGH=gemini-3-pro-preview
GEMINI_PARSE_TIMEOUT_SECONDS=120
# LlamaParse settings (when DOCUMENT_PARSER=llamaparse)
LLAMA_PARSE_TIMEOUT_SECONDS=300
LLAMA_PARSE_CHECK_INTERVAL=2
LLAMA_PARSE_MAX_CHECK_INTERVAL=10
LLAMA_PARSE_NUM_WORKERS=4
LLAMA_PARSE_VERBOSE=false
